...
pdf("Figure_5.pdf",height=15,width=20)
par(mar = c(15,4.1, 3.1, 3.1),xpd=TRUE)
barplot(myMatrix, col=rep_col, main="Percent of intervals covered by repeat classes",xlab="Atomic Interval",ylab="Abundance",font.lab=2,cex.lab=1.5,cex.main=1.5,font.axis=2)
