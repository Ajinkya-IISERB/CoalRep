...
repclass <- gsub("_"," ",sapply(strsplit(sapply(strsplit(sapply(strsplit(rep,"[/]"), `[`, 2), "[.]",1), `[`,1),"[.]"), `[`,1))
...
legend(5,3.5, inset=0.1, legend=c("PSMC Unmasked","PSMC Masked"),fill=c("red","blue"),cex=1.5,text.font=2)
dev.off()
