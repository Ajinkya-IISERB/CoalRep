...
pdf("Figure_S6.pdf",height=15,width=30)
par(mar = c(15,6.1, 3.1, 3.1),xpd=TRUE)
barplot(myMatrix, col=rep_col, xlab="Atomic Interval",ylab="Genome Fraction (in percent)",font.lab=2,cex.lab=1.5,cex.main=1.5,font.axis=2)
legend("bottom", inset=c(0,-0.25),legend=c(gsub("_"," ",row.names(myMatrix))),fill=rep_col,ncol = 5, border=NA,box.lty=2,cex=1.3,text.font=2)
box()
dev.off()
