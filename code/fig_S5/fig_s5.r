...
pdf("Figure_S5.pdf",height=15,width=30)
par(mar = c(15,6.1, 3.1, 3.1),xpd=TRUE)
barplot(myMatrix, col=rep_col, ylab="Percent Abundance",font.lab=2,cex.lab=1.5,cex.main=1.5,font.axis=2)
